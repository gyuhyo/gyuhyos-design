    ...
    return ((0, jsx_runtime_1.jsx)(react_1.default.Fragment, { children: (props.title !== undefined ||
            ...
            ((_f = props.buttons) === null || _f === void 0 ? void 0 : _f.custom) !== undefined) && ((0, jsx_runtime_1.jsxs)("div", __assign({ style: {
                ...
                padding: "0.5rem 0.75rem",
                        ...
                        columnGap: 7,
                        textWrap: "nowrap",
                    }) }, { children: [typeof props.title === "string" && props.title !== "" ? ((0, jsx_runtime_1.jsxs)("p", __assign({ style: { fontSize: 18, fontWeight: "bold" } }, { children: ["\u27A4 ", props.title] }))) : (props.title), props.description && ((0, jsx_runtime_1.jsx)("div", __assign({ style: {
                                fontSize: 12,
                                color: "#7a7a7a",
                            ...
                            !props.description && ((0, jsx_runtime_1.jsxs)("span", __assign({ style: {
                                fontSize: 12,
                                color: "#7a7a7a",
                                marginLeft: props.title !== undefined && props.title !== ""
                                    ? "7px"
                                    : "0px",
                            } }, { children: ["(", (0, jsx_runtime_1.jsx)("span", __assign({ style: { color: "var(--text-color)" } }, { children: "*" })), ") \uC785\uB825 \uAC00\uB2A5 (", (0, jsx_runtime_1.jsx)("span", __assign({ style: { color: "red" } }, { children: "*" })), ") \uD544\uC218\uC785\uB825"] })))] }))), (0, jsx_runtime_1.jsx)(buttons_1.default, { buttons: props.buttons, options: props.options, setInnerLoading: props.setInnerLoading, isDetailSearchFormOpen: isDetailSearchFormOpen, setIsDetailSearchFormOpen: setIsDetailSearchFormOpen }), (0, jsx_runtime_1.jsx)(DetailSearchForm, { isDetailSearchFormOpen: isDetailSearchFormOpen, setIsDetailSearchFormOpen: setIsDetailSearchFormOpen })] }))) }));
};
