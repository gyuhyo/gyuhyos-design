...
var NumberInput = react_1.default.memo(function (_a) {
    var col = _a.col;
    ...
    return ((0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { control: focusedRowForm.control, name: col.field, defaultValue: (0, devs_dt_slider_form_1.getDefaultValue)({
            ...
            return ((0, jsx_runtime_1.jsx)(antd_1.InputNumber, __assign({ status: (errors === null || errors === void 0 ? void 0 : errors.hasOwnProperty(col.field)) ? "error" : undefined, style: { width: "100%" }, defaultValue: (0, devs_dt_slider_form_1.getDefaultValue)({
                    val: defaultValue,
                    col: col,
                    row: row,
                    rowIndex: rowIndex,
...
exports.default = react_1.default.memo(NumberInput);
