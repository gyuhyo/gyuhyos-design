...
var LayerPopupHeader = React.memo(function (props) {
    var _a;
    var _b = __read(React.useState(false), 2), isDragging = _b[0], setIsDragging = _b[1];
    var _c = __read(React.useState({ x: 0, y: 0 }), 2), startPos = _c[0], setStartPos = _c[1];
    ...
    return (_jsxs("div", __assign({ "data-name": "layer-popup-header" }, { children: [_jsx("p", __assign({ onDoubleClick: props.isMaximized ? onMinimizedClick : onMaximizedClick, onMouseDown: handleMouseDown }, { children: (_a = props.title) !== null && _a !== void 0 ? _a : "Un Titled" })), _jsxs("div", __assign({ "data-name": "layer-popup-header-buttons" }, { children: [_jsx("i", { className: "fa-solid fa-compress", onClick: onMinimizedClick }), _jsx("i", { className: "fa-solid fa-expand", onClick: onMaximizedClick }), _jsx("i", { className: "fa-solid fa-xmark", onClick: props.onCloseClick })] }))] })));
});
