...
var DateTimeInput = React.memo(function (_a) {
    var _b;
    var col = _a.col;
    ...
    return (_jsx(Controller, { control: focusedRowForm.control, name: col.field, defaultValue: getDefaultValue({
            ...
            return (_jsx(DatePicker, __assign({ status: (errors === null || errors === void 0 ? void 0 : errors.hasOwnProperty(col.field)) ? "error" : undefined, style: { width: "100%" }, placeholder: "\uB0A0\uC9DC/\uC2DC\uAC04 \uC120\uD0DD", showTime: true, defaultValue: getDefaultValue({
                    val: defaultValue
