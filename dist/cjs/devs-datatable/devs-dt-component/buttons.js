...
var DevsDtButtons = function (props) {
    ...
    var _k = __read(react_1.default.useState(false), 2), visible = _k[0], setVisible = _k[1];
    var buttonRef = react_1.default.useRef(null);
    var popoverRef = react_1.default.useRef(null);
    var _l = __read(react_1.default.useState({ top: 0, left: 0 }), 2), position = _l[0], setPosition = _l[1];
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ style: {
            ...
            columnGap: 3,
                ...
                props.buttons.isSearchVisible === true) && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ border: true, compact: true, style: { padding: "5px 7px" }, onClick: (_c = props.buttons) === null || _c === void 0 ? void 0 : _c.onSearchClick }, { children: [(0, jsx_runtime_1.jsx)(md_1.MdSearch, {}), " \uC870\uD68C"] }))), (props.buttons.isAddVisible === undefined ||
                props.buttons.isAddVisible === true) && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ border: true, compact: true, style: { padding: "5px 7px" }, onClick: (_d = props.buttons) === null || _d === void 0 ? void 0 : _d.onAddClick }, { children: [(0, jsx_runtime_1.jsx)(md_1.MdAdd, {}), " \uCD94\uAC00"] }))), (props.buttons.isSaveVisible === undefined ||
                props.buttons.isSaveVisible === true) && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ border: true, compact: true, style: { padding: "5px 7px" }, onClick: (_e = props.buttons) === null || _e === void 0 ? void 0 : _e.onSaveClick }, { children: [(0, jsx_runtime_1.jsx)(md_1.MdSave, {}), " ", ((_f = props.options) === null || _f === void 0 ? void 0 : _f.enabledRowCheck) === true ? "선택 저장" : "저장"] }))), (props.buttons.isDeleteVisible === undefined ||
                props.buttons.isDeleteVisible === true) && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ border: true, compact: true, style: { padding: "5px 7px" }, bgColor: "#df4873", color: "#fff", onClick: (_g = props.buttons) === null || _g === void 0 ? void 0 : _g.onDeleteClick }, { children: [(0, jsx_runtime_1.jsx)(md_1.MdDelete, {}), " \uC120\uD0DD \uC0AD\uC81C"] }))), (props.buttons.isCancelVisible === undefined ||
                props.buttons.isCancelVisible === true) && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ border: true, compact: true, style: { padding: "5px 7px" }, onClick: (_h = props.buttons) === null || _h === void 0 ? void 0 : _h.onCancelClick }, { children: [(0, jsx_runtime_1.jsx)(md_1.MdCancel, {}), " \uCDE8\uC18C"] }))), ((_j = props.buttons.export) === null || _j === void 0 ? void 0 : _j.visible) === true && ((0, jsx_runtime_1.jsxs)(button_1.default, __assign({ btnref: buttonRef, border: true, compact: true, style: { padding: "5px 7px", position: "relative" }, onClick: function () { return setVisible(function (prev) { return !prev; }); } }, { children: [(0, jsx_runtime_1.jsx)(fa6_1.FaFileExport, {}), " Export", visible && ((0, jsx_runtime_1.jsxs)("div", __assign({ ref: popoverRef, style: {
                            position: "fixed",
                            top: position.top,
                            left: position.left,
                            padding: "10px",
