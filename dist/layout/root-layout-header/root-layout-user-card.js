...
var RootLayoutUserCard = React.memo(function () {
    ...
    var _a = useLayout(), host = _a.host, refreshTokenUrl = _a.refreshTokenUrl, languages = _a.languages, handleLanguageChange = _a.handleLanguageChange, onBeforeLogout = _a.onBeforeLogout;
    ...
    return (_jsxs("div", { children: [_jsx("div", __assign({ css: css({
                    ...
                    border: "1px solid var(--default-border-color)",
                    fontSize: "0.85rem",
                }) }, { children: [_jsx(RootLayoutUserSignTime, {}), _jsx(Button, __assign({ bgColor: "#1f619d", color: "#fff", compact: true, rounded: false, onClick: onRefreshClick }, { children: "\uC5F0\uC7A5" })), _jsx(Button, __assign({ bgColor: "#df4873", color: "#fff", compact: true, rounded: false, onClick: onSignOutClick }, { children: "\uB85C\uADF8\uC544\uC6C3" }))] })), _jsxs("div", __assign({ css: css({
                    lineHeight: "30px",
                    display: "none",
                    flexDirection: "row",
                    alignItems: "center",
