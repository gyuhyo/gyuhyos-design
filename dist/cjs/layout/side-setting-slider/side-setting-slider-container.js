...
var radio_button_1 = __importDefault(require("../../radio-button"));
function SideSettingSliderContainer() {
    ...
    var _c = (0, layout_context_1.useLayout)(), customSettings = _c.customSettings, themeChange = _c.themeChange, theme = _c.theme;
    ...
    return ((0, jsx_runtime_1.jsx)(backdrop_1.default, __assign({ isShow: isShow, onClick: onBackdropClick }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ css: (0, side_setting_slider_style_1.sideSettingSliderContainerStyle)({ opened: isShow }), onClick: function (e) { return e.stopPropagation(); } }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ css: (0, react_1.css)({
                        ...
                        rowGap: "14px",
                                ...
                                alignItems: "center",
                            }) }, { children: [(0, jsx_runtime_1.jsx)("p", { children: "Theme" }), (0, jsx_runtime_1.jsx)(radio_button_1.default, { background: "#000000", color: "#ffdd02", defaultValue: theme, onChange: function (value) { return themeChange(value); }, items: [
                                        {
                                            value: "light",
                                            label: (0, jsx_runtime_1.jsx)("i", { className: "fa-solid fa-sun" }),
                                        },
                                        {
                                            value: "dark",
                                            label: (0, jsx_runtime_1.jsx)("i", { className: "fa-solid fa-moon" }),
                                        },
                                    ] })] })), (0, jsx_runtime_1.jsxs)("div", __assign({ css: (0, react_1.css)({
                                lineHeight: "30px",
                                display: "flex",
                                flexDirection: "row",
                                justifyContent: "space-between",
