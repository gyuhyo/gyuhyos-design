...
function RootLayout() {
    ...
    return (_jsxs("div", __assign({ css: css({
            ...
            flexDirection: "row",
                ...
                }) }, { children: [_jsxs("div", __assign({ css: css({ flex: "none" }) }, { children: [_jsx(SideSettingSliderContainer, {}), _jsx(RootLayoutHeader, {})] })), _jsx("div", __assign({ css: css({ flex: "1 1 0%", overflow: "hidden" }) }, { children: _jsx(TabPanelContainer, {}) }))] }))] })));
}
