...
var DateInput = react_1.default.memo(function (_a) {
    var _b;
    var col = _a.col;
    ...
    return ((0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { control: focusedRowForm.control, name: col.field, defaultValue: (0, devs_dt_slider_form_1.getDefaultValue)({
            ...
            return ((0, jsx_runtime_1.jsx)(antd_1.DatePicker, __assign({ status: (errors === null || errors === void 0 ? void 0 : errors.hasOwnProperty(col.field)) ? "error" : undefined, style: { width: "100%" }, placeholder: "\uB0A0\uC9DC \uC120\uD0DD", defaultValue: (0, devs_dt_slider_form_1.getDefaultValue)({
                    val: defaultValue
...
exports.default = react_1.default.memo(DateInput);
