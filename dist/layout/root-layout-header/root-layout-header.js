...
function RootLayoutHeader() {
    ...
    return (_jsxs("header", __assign({ css: rootLayoutHeaderStyle }, { children: [_jsx("div", { children: _jsx("img", { src: "/header_logo_left1.png", width: 60, height: 30 }) }), _jsx(RootLayoutMenu, {}), _jsx(RootLayoutUserCard, {})] })));
}
