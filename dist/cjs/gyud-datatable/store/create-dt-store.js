        ...
        setDataSource: function (dataSource) {
            set(function (state) {
                var newDataSource = typeof dataSource === "function"
                    ? dataSource(state.dataSource).map(function (d) { return (__assign(__assign({}, d), { rowId: d.rowId || (0, react_uuid_1.default)() })); })
                    : dataSource.map(function (d) { return (__assign(__assign({}, d), { rowId: d.rowId || (0, react_uuid_1.default)() })); });
...
exports.createDtStore = createDtStore;
