...
function SideSettingSliderContainer() {
    ...
    var _c = useLayout(), customSettings = _c.customSettings, themeChange = _c.themeChange, theme = _c.theme;
    ...
    return (_jsx(Backdrop, __assign({ isShow: isShow, onClick: onBackdropClick }, { children: _jsxs("div", __assign({ css: sideSettingSliderContainerStyle({ opened: isShow }), onClick: function (e) { return e.stopPropagation(); } }, { children: [_jsxs("div", __assign({ css: css({
                        ...
                        rowGap: "14px",
                                ...
                                alignItems: "center",
                            }) }, { children: [_jsx("p", { children: "Theme" }), _jsx(RadioButton, { background: "#000000", color: "#ffdd02", defaultValue: theme, onChange: function (value) { return themeChange(value); }, items: [
                                        {
                                            value: "light",
                                            label: _jsx("i", { className: "fa-solid fa-sun" }),
                                        },
                                        {
                                            value: "dark",
                                            label: _jsx("i", { className: "fa-solid fa-moon" }),
                                        },
                                    ] })] })), _jsxs("div", __assign({ css: css({
                                lineHeight: "30px",
                                display: "flex",
                                flexDirection: "row",
                                justifyContent: "space-between",
